...
[![Build Status](https://travis-ci.org/babel/@hishprorg/labore-nam.svg?branch=master)](https://travis-ci.org/babel/@hishprorg/labore-nam)
[![Build status](https://ci.appveyor.com/api/projects/status/a0nbd84m1x4y5fp5?svg=true)](https://ci.appveyor.com/project/embercli/@hishprorg/labore-nam)
...
@hishprorg/labore-nam uses a persistent cache to enable rebuilds to be
...
In order to aid plugin developers in this process, @hishprorg/labore-nam
...
@hishprorg/labore-nam can run multiple babel transpiles in parallel using a
...
You can tell @hishprorg/labore-nam to use that function in the worker
processes like so:
